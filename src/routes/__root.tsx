  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Nimadir noto'g'ri ketdi. Qayta urinib ko'ring yoki bosh sahifaga qayting.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mulk-Go — mol-mulk oldi-sotdisi platformasi" },
      {
        name: "description",
        content:
          "Mulk-Go — ko'chmas mulk, transport va boshqa aktivlarni sotish, sotib olish va ijaraga berish uchun online platforma.",
      },
